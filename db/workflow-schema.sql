...
ALTER TABLE vehicles ADD COLUMN IF NOT EXISTS onboarding_state TEXT NOT NULL DEFAULT 'identity_confirmed';
ALTER TABLE vehicles ADD COLUMN IF NOT EXISTS onboarding_completed_at TIMESTAMPTZ;
...
ALTER TABLE vehicles DROP CONSTRAINT IF EXISTS vehicles_onboarding_state_check;
ALTER TABLE vehicles ADD CONSTRAINT vehicles_onboarding_state_check CHECK(onboarding_state IN ('identity_confirmed','history_pending','baseline_pending','ready'));
